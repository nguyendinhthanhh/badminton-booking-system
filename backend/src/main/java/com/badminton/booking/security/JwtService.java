...
public class JwtService {
    ...
    // 4.2 Các hàm này sử dụng các chức năng trích xuất làm ở trên để kiểm tra token
    // có hợp lệ hay không
    // before == < , after == >
    ...
    private String createToken(Map<String, Object> claims, String subject, long expiration) {
        return Jwts.builder() // Tạo bộ khung JWT
    ...
    // hàm này tạo access token bằng cách thiết lập claims cung cấp username(email
    ...
    // Tạo refresh token với UUID ngẫu nhiên
