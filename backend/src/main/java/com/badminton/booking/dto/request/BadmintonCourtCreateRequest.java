...
@NoArgsConstructor
@AllArgsConstructor
public class BadmintonCourtCreateRequest {
        ...
        @Pattern(regexp = "^(http|https)://.*$", message = "Image URL must be a valid HTTP or HTTPS URL")
        private String imageUrl;

        @Size(max = 10, message = "Maximum 10 images allowed")
        private java.util.List<@Size(max = 500, message = "Image URL must not exceed 500 characters") String> images;
