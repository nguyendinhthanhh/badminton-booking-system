...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
       ...
       /**
        * Kiểm tra overlap booking theo công thức: (start < existingEnd) && (end >
        * existingStart)
        ...
        * Trả về: [courtId, totalCount] - simplified for cross-DB compatibility
        */
       ...
       /**
        * Đếm số booking active của từng sân trong ngày (backup nếu TIMESTAMPDIFF không
        * work)
        */
